...
public class DownloadManager {
    ...
    void downloadButtonClick(ActionEvent event) {
        ...
        // https://learncode.com/python.exe
        String filename = url.substring(url.lastIndexOf("/")+1);
        String status = "STARTING";
        String action = "OPEN";
        String path = DOWNLOAD_PATH+ File.separator+filename;
    ...
    public void updateUI(FileInfo metaFile) {
        ...
        fileInfo.setPer((metaFile.getPer()));
    ...
    public void initialize()
    {
        ...
        TableColumn<FileInfo,String> per= (TableColumn<FileInfo,String>)this.tableView.getColumns().get(3);
